...
A função $g(x) = x^2$ é convexa. \todo{Eu uso isso lá no final do capítulo, quis despoluir lá na frente.}
\end{prop}
...
\begin{figure}[t]
    \centering
    \input{Figures/ClassificacaoDeMatrizesPorMonotonicidade.tikz}
...
A desigualdade que define as matrizes Monge é conhecida também por ``Condição de Monge'' ou ``Desigualdade Quadrangular''\cite{Yao:1980}.
