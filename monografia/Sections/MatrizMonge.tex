...
Iremos discutir agora um problema que será resolvido com um algoritmo apresentado somente no Capítulo~\ref{SMAWK}, o algoritmo SMAWK. Ele não será explicado neste momento. Será utilizado como caixa preta. Desta forma, poderemos introduzir de forma gradual e motivada estes resultados que são importantes na aplicação prática dos conhecimentos discutidos aqui e demonstram a utilidade de pensar em matrizes Monge e não só na monotonicidade ou total monotonicidade.  
